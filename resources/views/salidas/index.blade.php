...
<div class="bg-white rounded-lg shadow mb-6 p-4">
    <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div>
            ...
            <select name="tipo" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                <option value="">Todos</option>
        ...
        <div class="md:col-span-5 flex justify-end space-x-2">
            ...
            <a href="{{ route('salidas.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400">
                <i class="fas fa-undo mr-2"></i>Limpiar
            </a>
            <a href="{{ route('salidas.create') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 text-sm font-mono">{{ $salida->codigo }}</td>
                    <td class="px-6 py-4 text-sm">{{ $salida->fecha_salida->format('d/m/Y') }}</td>
                    <td class="px-6 py-4">{!! $salida->tipo_badge !!}</td>
                    <td class="px-6 py-4 text-sm font-bold">{{ $salida->total_formateado }}</td>
                    <td class="px-6 py-4">{!! $salida->estado_badge !!}</td>
                    <td class="px-6 py-4 text-sm">{{ $salida->usuario->name }}</td>
                    <td class="px-6 py-4">
