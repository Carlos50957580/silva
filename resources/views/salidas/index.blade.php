        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <h4 class="text-2xl font-bold text-green-600">
                    {{ number_format($stats['completadas']) }}
                </h4>
            </div>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <h4 class="text-2xl font-bold text-red-600">
                    {{ number_format($stats['canceladas']) }}
                </h4>
            </div>
    ...
    <form method="GET" class="grid grid-cols-1 md:grid-cols-6 gap-4">
        ...
        <div>
            ...
            >
                ...
                <option value="venta"
                    {{ request('tipo') == 'venta' ? 'selected' : '' }}>
                    Venta
                </option>

                <option value="transferencia"
                    {{ request('tipo') == 'transferencia' ? 'selected' : '' }}>
                    Transferencia
                </option>

                <option value="consumo"
                    {{ request('tipo') == 'consumo' ? 'selected' : '' }}>
                    Consumo
                </option>

                <option value="devolucion"
                    {{ request('tipo') == 'devolucion' ? 'selected' : '' }}>
                    Devolución
                </option>

                <option value="baja"
                    {{ request('tipo') == 'baja' ? 'selected' : '' }}>
                    Baja
                </option>
            </select>
        </div>
                        ...
                        <td class="px-6 py-4 text-sm">
                            ...
                            @if($salida->sucursal)
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="bg-blue-100 text-blue-600 rounded-full p-2 mr-2">
                                    ...
                                    <div>
                                        ...
                                        @if($salida->sucursal->codigo)
                                            <div class="text-xs text-gray-500">
                                                {{ $salida->sucursal->codigo }}
                                            </div>
                                        @endif
                                    </div>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                @if($salida->estado == 'pendiente')
                                    ...
                                    <!-- Editar -->
                                    <a
                                        href="{{ route('salidas.edit', $salida->id) }}"
                                    ...
                                    <!-- Cancelar -->
                                    <form
                                        action="{{ route('salidas.cancelar', $salida->id) }}"
                                        method="POST"
                                        class="inline"
                                    >
