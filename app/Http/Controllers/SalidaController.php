...
class SalidaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $stats = [
            ...
            'pendientes' => Salida::where(
                'estado',
                'pendiente'
            )->count(),

            'completadas' => Salida::where(
                'estado',
                'completada'
            )->count(),

            'canceladas' => Salida::where(
                'estado',
                'cancelada'
            )->count(),
        ];
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            'codigo' => 'required|unique:salidas,codigo',
            ...
            'tipo' => [
                'required',
                'in:venta,transferencia,consumo,devolucion,baja',
            ],
        ...
        if (!$sucursal) {
            return back()
                ->withInput()
                ->with('error', 'La sucursal seleccionada no está activa.');
        }
    ...
    public function edit($id)
    {
        ...
        if ($salida->estado !== 'pendiente') {
            return redirect()
                ...
                ->with(
                    'error',
                    'No se puede editar una salida que ya está ' .
                    $salida->estado
                );
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            /*
             * Primero restauramos el stock anterior.
             */
    ...
    public function destroy($id)
    {
        ...
        if ($salida->estado === 'completada') {
            return back()
                ->with(
                    'error',
                    'No se puede eliminar una salida completada.'
                );
        }
    ...
    public function cancelar($id)
    {
        ...
        if ($salida->estado !== 'pendiente') {
            return back()
                ->with(
                    'error',
                    'No se puede cancelar una salida que ya está ' .
                    $salida->estado
                );
        }
        ...
        try {
            ...
            /*
             * Si alguna vez se permite cancelar
             * una salida completada, aquí se puede
             * restaurar el stock.
             */
            if ($salida->estado === 'completada') {
